...
<html>
   ...
   <%
 try{
   String connectionURL = "jdbc:mysql://localhost:3306/koushik"; 
   Connection connection = null; 
   Class.forName("com.mysql.jdbc.Driver"); 
   connection = DriverManager.getConnection(connectionURL, "root", "koushik7799");
...
<h2 style="color:red">Unable to connet  databse!!!!</h2>
<%}%>
</body>
</html>